...
@observer
class MethodLibraryFilters extends React.Component {
  @observable
...
MethodLibraryFilters.propTypes = {
  collection: MobxPropTypes.objectOrObservableObject.isRequired,
  canEdit: PropTypes.bool,
}

MethodLibraryFilters.defaultProps = {
  canEdit: false,
}

export default MethodLibraryFilters
