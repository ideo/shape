...
const TestCollectionIcon = ({ size }) => (
  <Icon fill>
    ...
    >
      ...
      <path
        className="st0"
        d="M87.7-43.6c-1.2-2.1-1.9-4.5-1.9-7 0-5.6 3.3-10.4 8-12.7M112-43.6c-2.4 4.2-6.9 7-12.1 7-2.9 0-5.6-.9-7.8-2.4M99.8-64.6c7.7 0 14 6.3 14 14v1.1"
      />
      <path
        className="st1"
      ...
      <g>
        <path
          className="st5"
          d="M-34.6 19.8H-22M-32.8 19.7v-3M-29.9 19.7v-6.1M-27 19.7v-9.5M-24.1 19.7v-5"
        />
      </g>
      <path
        className="st4"
