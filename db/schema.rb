...
ActiveRecord::Schema.define(version: 20_190_220_192_800) do
  ...
  create_table 'external_records', force: :cascade do |t|
    ...
    t.index %w[external_id application_id externalizable_type], name: 'index_uniq_external_id', unique: true
