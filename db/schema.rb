...
ActiveRecord::Schema.define(version: 20_191_206_221_958) do
  ...
  create_table 'activities', force: :cascade do |t|
    ...
    t.index %w[action target_type organization_id], name: 'index_activities_action_target_org'
    t.index ['actor_id'], name: 'index_activities_on_actor_id'
    t.index ['created_at'], name: 'index_activities_on_created_at'
    t.index %w[destination_type destination_id], name: 'index_activities_on_destination_type_and_destination_id'
    t.index ['organization_id'], name: 'index_activities_on_organization_id'
    t.index %w[source_type source_id], name: 'index_activities_on_source_type_and_source_id'
    t.index %w[target_type target_id], name: 'index_activities_on_target_type_and_target_id'
  end
  ...
  create_table 'activity_subjects', force: :cascade do |t|
    ...
    t.index %w[subject_type subject_id], name: 'index_activity_subjects_on_subject_type_and_subject_id'
  end
  ...
  create_table 'api_tokens', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[application_id organization_id], name: 'index_api_tokens_on_app_id_org_id'
  ...
  create_table 'application_organizations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[application_id organization_id], name: 'index_app_org_on_app_id_org_id', unique: true
  end
  ...
  create_table 'collection_cards', force: :cascade do |t|
    ...
    t.index %w[identifier parent_id], name: 'index_collection_cards_on_identifier_and_parent_id'
    t.index ['item_id'], name: 'index_collection_cards_on_item_id'
    t.index %w[order row col], name: 'index_collection_cards_on_order_and_row_and_col'
  ...
  create_table 'comment_threads', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'organization_id'
    t.index %w[record_id record_type organization_id], name: 'index_comment_threads_on_record_and_org', unique: true
  end
  ...
  create_table 'comments', force: :cascade do |t|
    ...
    t.index %w[subject_id subject_type], name: 'index_comments_on_subject_id_and_subject_type'
  end
  ...
  create_table 'data_items_datasets', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[data_item_id dataset_id order selected], name: 'data_items_datasets_aggregate_index'
    t.index %w[data_item_id dataset_id], name: 'index_data_items_datasets_on_data_item_id_and_dataset_id', unique: true
  end
  ...
  create_table 'datasets', force: :cascade do |t|
    ...
    t.index %w[data_source_type data_source_id], name: 'index_datasets_on_data_source_type_and_data_source_id'
  ...
  create_table 'double_entry_line_metadata', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[line_id key value], name: 'lines_meta_line_id_key_value_idx'
  end
  ...
  create_table 'external_records', force: :cascade do |t|
    ...
    t.index %w[external_id application_id externalizable_type externalizable_id], name: 'index_external_records_common_fields'
    t.index %w[externalizable_type externalizable_id], name: 'index_on_externalizable'
  end
  ...
  create_table 'groups_roles', force: :cascade do |t|
    t.bigint 'group_id'
    t.bigint 'role_id'
    t.index %w[group_id role_id], name: 'index_groups_roles_on_group_id_and_role_id', unique: true
  ...
  create_table 'groups_threads', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.index %w[group_id comment_thread_id], name: 'by_groups_comment_thread', unique: true
  end
  ...
  create_table 'items', force: :cascade do |t|
    ...
    t.index %w[data_source_type data_source_id], name: 'index_items_on_data_source_type_and_data_source_id'
  ...
  create_table 'payments', force: :cascade do |t|
    ...
    t.index %w[purchasable_type purchasable_id], name: 'index_payments_on_purchasable_type_and_purchasable_id'
  ...
  create_table 'question_answers', force: :cascade do |t|
    ...
    t.index %w[question_id idea_id survey_response_id], name: 'index_question_answers_on_unique_idea_response', unique: true, where: '(idea_id IS NOT NULL)'
    t.index %w[question_id survey_response_id], name: 'index_question_answers_on_unique_response', unique: true, where: '(idea_id IS NULL)'
  ...
  create_table 'roles', force: :cascade do |t|
    ...
    t.index %w[resource_identifier name], name: 'index_roles_on_resource_identifier_and_name', unique: true
  ...
  create_table 'users_threads', force: :cascade do |t|
    ...
    t.index %w[user_id comment_thread_id], name: 'by_users_comment_thread', unique: true
  end
