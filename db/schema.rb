...
ActiveRecord::Schema.define(version: 20_190_815_222_240) do
  ...
  create_table 'question_answers', force: :cascade do |t|
    ...
    t.index %w[survey_response_id question_id], name: 'index_question_answers_on_survey_response_id_and_question_id', unique: true
  end
