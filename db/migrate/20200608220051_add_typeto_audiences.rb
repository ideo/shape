class AddTypetoAudiences < ActiveRecord::Migration[5.2]
  def up
    ...
    Audience.find_by(name: 'Admins')&.update(audience_type: 0)
    Audience.find_by(name: 'Reviewers')&.update(audience_type: 0)
    Audience.find_by(name: 'Participants')&.update(audience_type: 0)
  end
